...
impl Version {
    ...
    ///  - the key in the "errorCodes" field is the `u64` value of the
    /// `pppppppp` part of the `1_pppppppp_CCCCCCCCCCC_CCCCCCCCCCC_CCCCCCCCCCC_CCCCCCCCCCC_CCCCCCCCCCC`
    /// encoded revert code generated by a `panic` expression.
