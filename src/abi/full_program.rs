...
pub struct FullTypeDeclaration {
    ...
    pub alias_of: Option<Arc<FullTypeApplication>>,
}
...
impl FullTypeDeclaration {
    pub fn from_counterpart(
        ...
        let alias_of = type_decl
            .alias_of
            .as_ref()
            .map(|alias| Arc::new(FullTypeApplication::from_counterpart(alias, types)));
        FullTypeDeclaration {
...
mod tests {
    ...
    fn can_convert_alias_of() {
        ...
        let alias_type = UnifiedTypeDeclaration {
            ...
            components: None,
            type_parameters: None,
            alias_of: Some(Arc::new(alias_of_application.clone())),
        };
